        ...
        public ActionResult Confirmation(Models.FileUploadViewModel files, string ButtonType)
        {
            ...
            if (ButtonType == "Next")
            {
                ...
                try
                {
                    ...
                    Entity.Application currentApplication = new Entity.Application() { application_date = DateTime.Now, grade_applying_id = SelectedGrade.ID };
                    ...
                    foreach (var doc in applicantDocuments)
                    {
                        ...
                        if (doc.FileName != null)
                        {
                            ...
                            currentApplication.Documents.Add(new Entity.Document() { type = doc.Type, Doc_path = physicalPath, IsVerified = false });
                        }
                    }
